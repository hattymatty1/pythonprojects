...
bird_downflap = pygame.transform.scale2x(pygame.image.load('E:/Flappy_Bird/assets/bluebird-downflap.png').convert_alpha())
bird_midflap = pygame.transform.scale2x(pygame.image.load('E:/Flappy_Bird/assets/bluebird-midflap.png').convert_alpha())
bird_upflap = pygame.transform.scale2x(pygame.image.load('E:/Flappy_Bird/assets/bluebird-upflap.png').convert_alpha())
...
pipe_surface = pygame.image.load('E:/Flappy_Bird/assets/pipe-green.png')
