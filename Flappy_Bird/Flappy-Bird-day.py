...
bg_surface = pygame.image.load('E:/Flappy_Bird/assets/background-day.png').convert()
...
bird_downflap = pygame.transform.scale2x(pygame.image.load('E:/Flappy_Bird/assets/yellowbird-downflap.png').convert_alpha())
bird_midflap = pygame.transform.scale2x(pygame.image.load('E:/Flappy_Bird/assets/yellowbird-midflap.png').convert_alpha())
bird_upflap = pygame.transform.scale2x(pygame.image.load('E:/Flappy_Bird/assets/yellowbird-upflap.png').convert_alpha())
...
pipe_surface = pygame.image.load('E:/Flappy_Bird/assets/pipe-green.png').convert()
